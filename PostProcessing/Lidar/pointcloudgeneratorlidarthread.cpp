...
*/
    ...
    QMap<qint64, PostProcessingForm::Mid360Datagram*>::const_iterator mid360MultiMapIter = constData.mid360.datagrams->lowerBound(workUnitInProgress.beginningITOWTime_ns);
    ...
    while ((mid360MultiMapIter != constData.mid360.datagrams->end()) && (mid360MultiMapIter.key() < workUnitInProgress.endingITOWTime_ns) && !terminateRequest)
    {
        ...
        const PostProcessingForm::Mid360Datagram* mid360Datagram = mid360MultiMapIter.value();
