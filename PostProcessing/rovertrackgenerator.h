/*
    rovertrackgenerator.h (part of GNSS-Stylus)
...
#ifndef ROVERTRACKGENERATOR_H
#define ROVERTRACKGENERATOR_H

#include <QObject>

#include "postprocessingform.h"

class RoverTrackGenerator : public QObject
{
    Q_OBJECT
...
public:
    ...
    public:
        ...
        {
            FF_NONE = 0,
            FF_RAW,         // Raw numeric value
            FF_CARR_SOLN,   // Bits 3...4 (0 = no carrier phase range solution, 1 = float, 2 = fixed)
        };
...
//        LOSolver* loSolver;
        const PostProcessingForm::Rover* rover = nullptr;
        ...
        CoordsFormat accuracyFormat = CF_FLOAT;
        QByteArray endOfLine = "\n";
        TimeFormat timeFormat = TF_ITOW;
        FlagsFormat flagsFormat = FF_CARR_SOLN;
...
//        int numberOfDecimals_Quaternion = 6;
    ...
    void generateTrack(const Params& params);
...
private:
    ...
    void writeRELPOSNEDItem(const UBXMessage_RELPOSNED& relPosNED, const unsigned int time);
